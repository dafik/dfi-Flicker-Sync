...
var json = require(global.libPath + '/app/flickr/FlickrJson');
//var request = require('./request');
var request = require(global.libPath + '/app/flickr/FlickrRequest');
...
var requestFactory = function (consumer_key, consumer_secret, oauth_token, oauth_token_secret) {
    ...
    return function (opts, callback, callbackThis, requestCallback, requestCallbackThis) {
        // callback signature: function(err, response_object)
        // opts.api_key = consumer_key;
        // logger.debug('Flickr API: %j', opts);
        request(opts, oauth_client, oauth_token, oauth_token_secret, onRequest, this, requestCallback, requestCallbackThis);
        function onRequest(err, res) {
            ...
            parseResponse(res, function (err, result) {
                ...
                callback.call(callbackThis, null, result);
            });
        }
    };
};
