...
var FlickrRequestFactory = require(global.libPath + '/app/flickr/FlickrRequestFactory');
...
function getApi(options, conf, callback, thisp, requestCallback, requestCallbackThis) {

    if (typeof  api != "function") {
        function onCredentials(credentials) {


            api = FlickrRequestFactory(
    ...
    function onApi() {
        var request = api(options, onResponse, this, requestCallback, requestCallbackThis)
