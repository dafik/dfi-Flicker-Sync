...
var DfiSync = {
    ...
    sync: {
                                        ...
                                        if (!hasItem(flickr[fCollectionKey].children, lPhotoset.title)) {
                                            ...
                                            if (lPhotoset.hasOwnProperty('children') && lPhotoset.children.length > 0) {
                                                ...
                                                lPhotoset.children.forEach(function (lPhoto) {
                                                    ...
                                                    try {
                                                        var z1 = flickr[fCollectionKey].hasOwnProperty('children');
                                                        var z2 = flickr[fCollectionKey].children[fPhotoSetKey].hasOwnProperty('children');
                                                        var z3 = !hasItem(flickr[fCollectionKey].children[fPhotoSetKey].children, lPhoto.title);
         ...
         * @param thisp
         */
        getTrees: function (calback, thisp) {
            if (this.treesLoaded) {
                setTimeout(function () {
                    calback.call(thisp);
                }, 500);
            ...
            function onFlickrCollections(collections) {
                ...
                collections.forEach(function (collection) {
                    ...
                    if (collection.hasOwnProperty('set')) {
                        item = {title: collection['$'].title, folder: true, children: []};
                        results.push(item);
