...
var DfiSync = {
    ...
    init: function (gui) {
        var self = this;
        this.gui = gui;
        this.aside.init(self);
        this.configuration.init(self);
        this.local.init(self);
        this.flickr.init(self);
        this.sync.init(self);
    ...
    flickr: {
        ...
        findPhotoSetThumbnails: function (tmp) {
            ...
            function setImage(data) {
                ...
                this.view.find(' .files div[data-id=' + data['$'].id + ']').find('img.imgThumb').attr('src', url)
            }
