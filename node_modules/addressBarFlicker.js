...
var gen_bar = jade.compile([
    ...
    '    li(data-type="#{item.type}" data-id="#{item.id}")',
    '      a(href="#") #{item.name}',
    '      span.divider /',
    '  - else',
    '    li.active(data-type="#{item.type}" data-id="#{item.id}")',
    '      a(href="#") #{item.name}',
].join('\n'));

var genOneFile = jade.compile([
    'li(data-type="#{item.type}" data-id="#{item.id}")',
    '  a(href="#") #{item.name}',
].join('\n'));
...
AddressBar.prototype.enter = function (mine) {
    ...
    // Add new folder
    var x = this.element.append(genOneFile({item: mine}));
